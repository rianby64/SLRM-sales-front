;(function() {
  ...
  function commpropPDFcontroller($scope, $stateParams, orderFormHTTP, commpropVariantsHTTP, commpropGoodsHTTP, goodsPhotosHTTP, authService) {
...
//      commpropVariantsHTTP.read().success(function(variants) {
      var variant = commprop.commercial_proposal_variant;
