...
<div class="row" ng-if="normalTheme"><div class="container" style="margin-top:10px;margin-bottom:10px;"><div class="row text-right"><a ui-sref="{{base}}.create" class="btn btn-primary">Добавить</a></div></div></div> \
